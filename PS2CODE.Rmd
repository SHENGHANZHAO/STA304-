...
log(p/1-p) = β0 + β1*age + β2*income_family$125,000 and more + β3*income_family$25,000 to 49,999 + β4*income_family$50,000 to 74,999 + β5*income_family$75,000 to 99,999 + β6*income_familyLess than $25,000 + β7*self_rated_mental_healthFair + β8*self_rated_mental_healthGood + β9*self_rated_mental_healthPoor + β10*self_rated_mental_healthVery good      
     
Where p represents the probability that the classification of life satisfaction is “relatively satisfied”. The value of the intercept β0 represents the log odds that the respondent is relatively satisfied in life, with an age of 0, a family income within the range between $100,000 and $124,999, as well as an excellent subjective mental health. β1 represents the change in log odds of being relatively satisfied in life associated with one year increase in age when controlling all other factors constant. Family income is categorized into six groups: Below $25,000; From $25,000 to 49,999; From $50,000 to $74,999; From $75,000 to $99,999; From $100,000 to $124,999; Above $125,000. β2 to β6 are coefficients of the dummy variables for family income, representing the change in log odds of being relatively satisfied in life compared to the base group (i.e., the group with family income between $100,000 and $124,999). Similarly, self-rated mental health is categorized into five groups: Poor; Fair; Good; Very good; Excellent. β7 to β10 are coefficients of the dummy variables for self-rated mental health, representing the change in log odds of being relatively satisfied in life compared to the base group (i.e., the group with an excellent rating on mental health).    
